---
name: cross-check-with-another-model
...
considerably more than a confident deletion. (`decide-if-data-is-dead` covers
...
`verify-before-claiming`. If it gives you a question nobody can answer, it
belongs in the gap list — see `map-what-you-dont-know`.
