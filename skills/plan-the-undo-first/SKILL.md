...
must be able to go back without reconstructing anything — see `hand-off-work`.
...
See `change-production-safely` for the full sequence the undo plan sits inside.
