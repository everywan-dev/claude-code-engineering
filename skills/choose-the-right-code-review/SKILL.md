---
name: choose-the-right-code-review
...
See `verify-before-saying-done` for what makes any single check count, and
`write-the-rollback-plan-first` for the rollback every level-2 and level-3 review is
supposed to read.
