...
- **Refactoring is not part of the loop.** It belongs to the review stage (see the `review-changes-against-spec-and-standards` skill), not the red → green implementation cycle.
